      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          >
                ...
                return (
                  <div
                    ...
                    className={`relative border-b border-zinc-800/50 ${
                      isDragOver ? 'bg-yellow-500/10' : 'bg-zinc-900/30'
                    }`}
                    style={{ height: TRACK_HEIGHTS[track.type] }}
                  ...
                  >
                    ...
                    {/* Drop indicator */}
                    {isDragOver && (
                      <div className="absolute inset-0 flex items-center justify-center text-xs text-yellow-400 pointer-events-none border-2 border-dashed border-yellow-500/50 rounded">
                        Drop to add clip
                      </div>
                    )}
            ...
            {/* Playhead */}
            <div
              className="absolute top-0 bottom-0 w-0.5 bg-yellow-500 z-40 pointer-events-none"
            ...
            >
              ...
              >
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-yellow-500" />
              </div>
            </div>
          </div>
        </div>
